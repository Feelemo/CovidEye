		...
		<div class="container" id="register">
			...
			<div class="card card-outline-secondary">
				<div class="card-header">
					<center><h3 class="mb-0" style="color:#3399ff;"><i class="fa fa-medkit"></i> Test Kit Stock Info</h3></center>
				</div>
				...
				<div class="card-body">
					<div class="form-group row">
						<label for="testCentreName" class="col-sm-6 col-lg-3 col-form-label font-weight-bold"><i class="fa fa-medkit"></i> Test Kit ID:</label>
					...
					<div class="form-group row">
						<label for="testCentreAddress" class="col-sm-6 col-lg-3 col-form-label font-weight-bold"><i class="fa fa-medkit"></i> Name of Test Kit:</label>
						<div class="col-sm-12 col-lg-9">
							<input type="text" readonly class="form-control-plaintext" id="applicantNameInput" value="<?php echo "$kitName"; ?>">
						</div>
					</div>
					
					<div class="form-group row">
						<label for="testCentreContact" class="col-sm-6 col-lg-3 col-form-label font-weight-bold"><i class="fa fa-medkit"></i> Available Stock:</label>
						<div class="col-sm-12 col-lg-9">
					...
					<div class="form-group row">
						...
						<div class="col-lg-6">
							<a href="/Assignment/assets/php/findTestKit.php" class="btn btn-primary">Cancel</a>
						</div>
					</div>
				</div>
			</div>
