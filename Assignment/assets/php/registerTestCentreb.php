...
<head>
	...
	<title>Covideye &#124; Register Test Centre</title>
	<!-- Bootstrap CSS -->
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="nav nav-pills" role="tablist">
				...
				<li class="nav-item pill-2">
					<a class="nav-link active" href="/Assignment/assets/php/registerTestCentreb.php">Register Test Centre</a>
				</li>
		...
		<div class="container" id="register">
			...
			<div class="card card-outline-secondary">
				<div class="card-header">
					<center><h3 class="mb-0" style="color:#3399ff;"><i class="fas fa-clinic-medical"></i> Register A Test Centre</h3></center>
				</div>

				<div class="card-body">
					<div class="form-group row">
						<label for="testCentreName" class="col-sm-6 col-lg-3 col-form-label"><i class="fas fa-clinic-medical"></i> Name of Test Centre</label>
						<div class="col-sm-12 col-lg-9">
							<input type="name" class="form-control" id="username" placeholder="Test Centre's Name" name="testcentre_name" required>
							<div class="invalid-feedback">Please enter the test centre's name.</div>
						</div>
					</div>

					<div class="form-group row">
						<label for="testCentreAddress" class="col-sm-6 col-lg-3 col-form-label"><i class="fas fa-map-marker-alt"></i> Address</label>
						<div class="col-sm-12 col-lg-9">
							<input type="name" class="form-control" id="name1" placeholder="Test Centre's Address" name="testcentre_address" required>
							<div class="invalid-feedback">Please enter the test centre's address.</div>
						</div>
					</div>
					
					<div class="form-group row">
						<label for="testCentreContact" class="col-sm-6 col-lg-3 col-form-label"><i class="fas fa-phone-alt"></i> Contact Number</label>
						<div class="col-sm-12 col-lg-9">
							<input type="tel" class="form-control" id="phoneNumber" placeholder="Test Centre's Contact Number" name="testcentre_contact" pattern="[0-9]{11}" required>
							<div class="invalid-feedback">Please enter the test centre's contact number.</div>
						</div>
					</div>
				</div>
					...
					<div class="form-group row">
						...
						<div class="col-lg-7">
							<input type="submit" id="mySubmit" class="btn btn-primary" name="mySubmit" value="Register" disabled>
						</div>
					</div>
			</div>
		</div>
