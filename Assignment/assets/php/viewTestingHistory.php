...
<head>
	...
	<title>CovidEye &#124; Testing History</title>
	<!-- Bootstrap CSS -->
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="nav nav-pills" role="tablist">
				...
				<li class="nav-item pill-2">
					<a class="nav-link active" href="/Assignment/assets/php/registerTestCentre.php">Patient's Testing History</a>
				</li>
			...
			<div class="col-auto">
				<table class="mx-auto table table-hover table-responsive">
					<?php
						...
						$query = "Select PatientUsername , PatientPassword, PatientName , PatientType,PatientSymptoms,TesterUsername , TestID , TestDate ,TestName, ResultDate,Result from patient , CovidTest,testkit where patient.PatientID = CovidTest.PatientID and CovidTest.TestKitID = testkit.KitID and PatientUsername = '$patientUsername'";
