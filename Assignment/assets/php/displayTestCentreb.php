		...
		<div class="container" id="register">
			...
			<div class="card card-outline-secondary">
				...
				<?php
					...
					$query = "SELECT * FROM testcentre WHERE CentreName = '$centreName' LIMIT 1";
				...
				<div class="card-body">
					<div class="form-group row">
						<label for="testCentreName" class="col-sm-6 col-lg-3 col-form-label font-weight-bold"><i class="fas fa-clinic-medical"></i> Test Centre ID:</label>
