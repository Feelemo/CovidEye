...
<head>
	...
	<title>Covideye &#124; Tester Record</title>
	<!-- Bootstrap CSS -->
		...
		<div class="container" id="register">
			...
			<div class="card card-outline-secondary">
				<div class="card-header">
					<center><h3 class="mb-0" style="color:#3399ff;"><i class="fas fa-user-nurse"></i> Tester Info</h3></center>
				</div>
				...
				<?php
					...
					// Select data
					$testerUsername = $_SESSION['testerUsername'];
					$sql = "SELECT * FROM centreofficer WHERE Username = '$testerUsername' LIMIT 1";
				...
				<div class="card-body">
					<div class="form-group row">
						...
						<div class="col-sm-12 col-lg-9">
							<input type="text" readonly class="form-control-plaintext" id="applicantNameInput" value="<?php echo "$testerUsername"; ?>">
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-12 col-lg-9">
							<input type="text" readonly class="form-control-plaintext" id="applicantNameInput" value="<?php echo "$password"; ?>">
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-12 col-lg-9">
							<input type="text" readonly class="form-control-plaintext" id="applicantNameInput" value="<?php echo "$name"; ?>">
						</div>
					</div>

					<div class="form-group row">
						<label for="income" class="col-sm-6 col-lg-3 col-form-label"><i class="fa fa-id-card "></i> Position</label>
						<div class="col-sm-12 col-lg-9">
							<input type="text" readonly class="form-control-plaintext" id="applicantNameInput" value="<?php echo "$position"; ?>">
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-lg-6">
							<a href="/Assignment/assets/php/recordTester.php" class="btn btn-primary">Cancel</a>
						</div>
					</div>
				</div>
			</div>
