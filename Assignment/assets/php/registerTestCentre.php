		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="nav nav-pills" role="tablist">
				...
				<li class="nav-item pill-2">
					<a class="nav-link active" href="/Assignment/assets/php/registerTestCentre.php">Register Test Centre</a>
				</li>
				...
				<div class="card-body">
					<div class="form-group row">
						...
						<div class="col-sm-12 col-lg-9">
							<input type="name" class="form-control" id="centreName" placeholder="Test Centre's Name" name="testcentre_name" required>
					...
					<div class="form-group row">
						...
						<div class="col-sm-12 col-lg-9">
							<input type="tel" class="form-control" id="phoneNumber" placeholder="Test Centre's Contact Number" name="testcentre_contact" pattern="[0-9]{10}" required>
					...
					<div class="form-group row">
						...
						<div class="col-lg-6">
							<input type="submit" id="mySubmit" class="btn btn-primary" name="mySubmit" value="Register">
						</div>
					</div>
				</div>
			</div>
