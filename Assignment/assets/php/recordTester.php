		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="nav nav-pills" role="tablist">
				...
				<li class="nav-item pill-3">
					<a class="nav-link active" href="/Assignment/assets/php/recordTester.php">Record Tester</a>
				</li>
		...
		<div class="container" id="register">
			...
			<div class="card card-outline-secondary">
				<div class="card-header">
					<center><h3 class="mb-0" style="color:#3399ff;"><i class="fas fa-user-nurse"></i> Record Tester</h3></center>
				</div>
				...
				<div class="card-body">
					<div class="form-group row">
						...
						<div class="col-sm-12 col-lg-9">
							<input type="name" class="form-control" id="testerusername" placeholder="Username" name="tester_username" required>
					...
					<div class="form-group row">
						...
						<div class="col-sm-12 col-lg-9">
							<input type="password" class="form-control" id="password" placeholder="Password" name="tester_password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" required> &nbsp
					...
					<div class="form-group row">
						...
						<div class="col-sm-12 col-lg-9">
							<input type="name" class="form-control" id="name1" placeholder="Eg. MARILYN MICHAUD" name="tester_fullname" pattern="[A-Z\s]+" required>
							<div class="invalid-feedback">Please enter your full name in upper case letters.</div>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-12 col-lg-9">
						<label for="tester" class="col-sm-6 col-lg-3 col-form-label"><b>Tester</b></label>
						</div>
					</div>
